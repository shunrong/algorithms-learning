...
| 25 | ✅ | 111 | [二叉树的最小深度](https://leetcode.cn/problems/minimum-depth-of-binary-tree/) | 🟢 | `树` `深度优先搜索` `广度优先搜索` `二叉树` |  |
...
| 62 | ⭕ | 326 | [3 的幂](https://leetcode.cn/problems/power-of-three/) | 🟢 | `递归` `数学` |  |
